...
class OSVDevService:
    ...
    @staticmethod
    def is_version_affected(vuln: dict, pkg_name: str, pkg_version: str, ecosystem: str) -> bool:
        ...
        version is within the affected version ranges for the specified ecosystem. The
        function handles version comparisons, extracting the necessary details about the
        introduced and fixed versions.

        Parameters
        ----------
        vuln : dict
            A dictionary representing the vulnerability data. It is expected to contain the
            affected versions and ranges of the package in question.

        pkg_name : str
            The name of the package to check for vulnerability. This must match the package
            name in the vulnerability data.

        pkg_version : str
            The version of the package to check for being affected by the vulnerability.

        ecosystem : str
            The ecosystem (e.g., GitHub Actions, npm) to which the package belongs. This must match
            the ecosystem in the vulnerability data.
